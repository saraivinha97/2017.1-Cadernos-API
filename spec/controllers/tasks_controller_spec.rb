...
RSpec.describe TasksController, type: :controller do
  ...
  before(:all) do
      ...
      @category.save
      @book = FactoryGirl.create :category
      @book.save
  end
    let(:valid_attributes) {
    {title: 'testTask', user_id: @user.id, category_id: @category.id, book_id: @book.id}
    }

    let(:invalid_attributes) {
    {title: nil, user_id: nil, category_id: nil,    book_id: nil}
    }
